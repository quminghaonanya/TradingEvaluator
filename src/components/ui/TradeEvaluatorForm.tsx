...
import { createTradeHistory, fetchTradeHistory, getNextId } from "../client/DbClient";
import { MAX_LOSS_PCT, MUST_TP_PCT } from "../constants";
import { formatNumber } from "./utils";


interface TradeEvaluatorFormProps {
    reloadHistory: () => void;
    handleSymbolChange: (symbol: string) => void;
}


export const TradeEvaluatorForm: React.FC<TradeEvaluatorFormProps> = ({ reloadHistory, handleSymbolChange }: TradeEvaluatorFormProps) => {
    ...
    const handleSymbolChangeInner = (symbol: string) => {
        setSymbol(symbol);
            ...
            <CardContent className="space-y-4 p-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input type="text" value={symbol} onChange={(e) => handleSymbolChangeInner(e.target.value.toUpperCase())} />
                    </div>
